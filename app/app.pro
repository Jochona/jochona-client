...
unix:!macx: {
    ...
    # Jochona: linuxdeploy requires Icon=com.jochona.client to exist as
    # hicolor/<size>/apps/com.jochona.client.png; generated by
    # scripts/generate-brand-assets.py.
    icons128.files = res/hicolor/128x128/apps/com.jochona.client.png
    icons128.path = $$PREFIX/$$DATADIR/icons/hicolor/128x128/apps/
    icons512.files = res/hicolor/512x512/apps/com.jochona.client.png
    icons512.path = $$PREFIX/$$DATADIR/icons/hicolor/512x512/apps/
    ...
    INSTALLS += target desktop icons128 icons512 appstream
}
win32 {
