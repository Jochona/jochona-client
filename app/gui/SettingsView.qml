...
Flickable {
    ...
    Component.onDestruction: {
        ...
        // deactivating callback if the user just closes Jochona
        StreamingPreferences.save()
    }
        ...
        SettingsSection {
            ...
            Column {
                ...
                CheckBox {
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Mutes Jochona's audio when you Alt+Tab out of the stream or click on a different window.")
                }
            }
        }
                    ...
                    onActivated : {
                        ...
                        if (StreamingPreferences.language !== new_language) {
                            ...
                            if (!StreamingPreferences.retranslate()) {
                                ToolTip.show(qsTr("You must restart Jochona for this change to take effect"), 5000)
                            }
                            else {
                ...
                Row {
                    ...
                    CheckBox {
                        ...
                        ToolTip.text: qsTr("This enables the capture of system-wide keyboard shortcuts like Alt+Tab that would normally be handled by the client OS while streaming.") + "\n\n" +
                                      qsTr("NOTE: Certain keyboard shortcuts like Ctrl+Alt+Del on Windows cannot be intercepted by any application, including Jochona.")
                    }
        ...
        SettingsSection {
            ...
            Column {
                ...
                CheckBox {
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Allows Jochona to capture gamepad inputs even if it's not the current window in focus")
                }
            }
        }
